...
const offeringsData = [
  {
    key: "oil-gas-logistics",
    icon: "GasPump",
  },
  {
    key: "project-supply-chains",
    icon: "Truck",
  },
  {
    key: "secure-transport",
    icon: "Shield",
  },
];

const TransportServicePage = () => {
  const t = useTranslations("Services.transport");
    ...
    <div>
      ...
      <section className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-6 text-center">
          <IconComponents.Truck size="xl" className="text-red-400 mb-4" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {offeringsData.map((offering, index) => {
              ...
              return (
                <div
                  key={offering.key}
                  className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border border-orange-200"
                >
      ...
      <section className="py-20 bg-gradient-to-br from-orange-600 to-orange-700 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <Link
            href={`/${locale}/contact`}
            className="inline-flex items-center bg-white text-orange-600 font-semibold px-8 py-3 rounded-lg hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
